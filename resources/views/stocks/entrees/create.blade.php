...
<head>
    ...
    <title>Enregistrer une entrée en stock</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <div class="breadcrumbs-area clearfix m-3">
                            <h4 class="page-title pull-left">Nouvelle Entrée en stock</h4>
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            ...
                            <div class="col-12 mt-5" style="margin-left: 300px">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Enregistrer une entrée en stock</h4>
                                        <label>Tous les champs possédant l'étoile rouge(<span style="color: red">*</span>) sont obligatoires</label>
                                        <form method="POST" action="{{ route('entree_stock.store') }}">
                                        @csrf
                                            <div class="form-row align-items-center">
                                                <div class="col-md-12 my-3">
                                                    <label>Catégorie<span style="color: red">*</span></label>
                                                    <select name="famille" id="" class="form-control p-2 @error('famille') is-invalid @enderror">
                                                ...
                                                <div class="col-md-12 my-3">
                                                    ...
                                                    <input type="text" class="form-control @error('libelle_stock') is-invalid @enderror" name="libelle_stock" placeholder="Entrer la désignation">
                                                    @error('libelle_stock')
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="col-md-12 my-3">
                                                    ...
                                                    <input type="number" class="form-control @error('qte_stock') is-invalid @enderror" name="qte_stock" placaholder="Entrer la quantité initiale">
                                                    @error('qte_stock')
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="col-md-12 my-3">
                                                    ...
                                                    <input type="date" class="form-control @error('date_entree_st') is-invalid @enderror" name="date_entree_st">
                                                    @error('date_entree_st')
                                                    <div class="invalid-feedback">
                                                        La date est requise
                                                    </div>
                                                    @enderror
