...
<head>
    ...
    <title>Ajouter une entrée en stock</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <div class="breadcrumbs-area clearfix m-3">
                            <h4 class="page-title pull-left">Ajouter d'une entrée en stock</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="{{ route ('entree_stock')}}">Entrée-Stock</a></li>
                                <li><span>Formulaire d'ajout</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="row align-items-center">
                            ...
                            <div class="col-12 mt-5" style="margin-left: 300px">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Ajouter une entrée en stock</h4>
                                        <form method="POST" action="{{ route('entree_stock.updateEntrance', $sent->id) }}">
                                        @csrf
                                        @method('PATCH')
                                            <div class="form-row align-items-center">
                                                ...
                                                <div class="col-md-12 my-3">
                                                    ...
                                                    <input type="number" class="form-control" name="qte_stock" placaholder="Entrer la quantité initiale">
                                                </div>
                                                <div class="col-md-12 my-3">
                                                    <label>Date d'Entrée</label>
                                                    <input type="date" class="form-control" name="date_entree_st">
                                                </div>
                                            </div>
                                            <input type="hidden" name="acteur_id" value="{{Auth::user()->id}}">
                                            <button type="submit" name="save" class="btn btn-primary btn-sm mt-4 pr-4 pl-4">Ajouter</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
