...
<head>
    ...
    <title>Modifier une rubrique</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix m-3">
                            <h4 class="page-title pull-left">Modification d'une Rubrique</h4>
                    ...
                    <div class="col-lg-6">
                        <div class="row align-items-center">
                            ...
                            <div class="col-12 mt-5" style="margin-left: 300px">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Modifier une rubrique</h4>
                                        <form method="POST" action="{{ route('rubrique.update', $rub->id) }}">
                                        @csrf
                                        @method('PATCH')
                                            <div class="form-row align-items-center">
                                                <div class="col-md-12 my-3">
                                                    <label>Libellé de la rubrique</label>
                                                    <input type="text" class="form-control" name="libelle_rub" value="{{ $rub->libelle_rub }}" placeholder="Entrer le libellé">
                                                </div>
                                                <div class="col-md-12 my-3">
                                                    <label>Sélectionner une couleur</label>
                                                    <input type="color" name="couleur" value="{{ $rub->couleur }}">
                                                </div>
                                            </div>
