                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        ...
                        <ul class="breadcrumbs pull-left">
                            ...
                            <li><span>Liste des sorties</span></li>
                        </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    @include('layouts.flash_message')
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Liste des Sorties de Caisse</h4>
                                <div class="data-tables">
                                    <table id="dataTable" class="text-center">
                                        ...
                                        @foreach($sortie as $sort) 
                                            ...
                                            <tr>
                                                <td>{{ $num }}</td>
                                                <td>{{ $sort->libelle_sort_cais }}</td>
                                                <td>{{ $sort->rubrique->libelle_rub }}</td>
                                                <td>{{ $sort->mont_sort }} FCFA</td>
                                                <td>{{ $sort->beneficiaire }}</td>
                                                <td>{{ $sort->date_sort_cais }}</td>
                                                <td>
                                                    <ul class="d-flex justify-content-center">
                                                        <li class="mr-3"><a href="{{ route('sortie_caisse.edit', $sort->id) }}" class="btn btn-primary btn-xs" title="Modifier une sortie"><i class="fa fa-edit"></i></a></li>
                                                        @can('delete', 'App\SortieCaisse')
                                                            <li>
                                                                <form method="POST" action="{{ route('sortie_caisse.destroy', $sort->id)}} ">
                                                                    @csrf
                                                                    @method('DELETE')
