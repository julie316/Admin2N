...
<head>
    ...
    <title>Modifier une sortie de stock</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-8">
                        <div class="breadcrumbs-area clearfix m-3">
                            <h4 class="page-title pull-left">Modification d'une sortie de stock</h4>
                            ...
                            <div class="col-12 mt-5" style="margin-left: 300px">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="{{ route('sortie_stock.update', $sort->id) }}">
                                        @csrf
                                        @method('PATCH')
                                            <div class="form-row align-items-center">
                                                <div class="col-md-12 my-3">
                                                    <label>Libellé des Entrées en Stock</label>
                                                    <select name="stock_id" id="" class="form-control">
                                                        ...
                                                        @foreach($entrees as $ent)
                                                            <option value="{{$ent->id}}" {{$sort->stock_id == $ent->id ? 'selected' : ''}}>{{$ent->libelle_stock}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-md-12 my-3">
                                                    <label>Bénéficiaire</label>
                                                    <input type="text" class="form-control" name="destinataire" value="{{ $sort->destinataire }}" placeholder="Entrer le nom du bénéficiaire">
                                                </div>
                                                <div class="col-md-12 my-3">
                                                    <label>Quantité</label>
                                                    <input type="number" class="form-control" name="qte_sortie" value="{{$sort->qte_sortie}}">
                                                </div>
                                                <div class="col-md-12 my-3">
                                                    <label>Date de sortiet</label>
                                                    <input type="date" class="form-control" name="date_sortie_stock" value="{{$sort->date_sortie_stock}}">
                                                </div>
                                            </div>
